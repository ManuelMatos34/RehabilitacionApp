...
namespace FisioTerapias.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(RehabilitacionContext context)
        {
            _context = context;
        }
        ...
        {
            var rehabilitacionContext = _context.Usuarios.Include(u => u.IdEmpleadoNavigation).Include(u => u.IdRolNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,Usuario1,Clave,Correo,IdEmpleado,IdRol")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,Usuario1,Clave,Correo,IdEmpleado,IdRol")] Usuario usuario)
        {
