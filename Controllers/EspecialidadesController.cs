...
namespace FisioTerapias.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public EspecialidadesController(RehabilitacionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEspecialidad,Descripcion")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEspecialidad,Descripcion")] Especialidade especialidade)
        {
